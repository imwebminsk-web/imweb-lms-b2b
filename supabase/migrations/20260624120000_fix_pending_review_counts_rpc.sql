-- Phase 380: pending-счётчик когорт только для заданий с save_to_journal.
...
COMMENT ON FUNCTION public.get_my_pending_review_counts() IS
  'Число сдач со статусом pending по когортам для курсов текущего преподавателя; только блоки assignment с save_to_journal = true.';
