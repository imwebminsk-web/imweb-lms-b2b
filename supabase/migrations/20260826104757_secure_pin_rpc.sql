-- PIN join: только роль student; неопубликованный курс выглядит как неверный PIN.
...
COMMENT ON FUNCTION "public"."join_cohort_by_pin"("p_pin" "text") IS
  'Запись ученика в группу по PIN. Только role=student. Неопубликованный курс возвращает not_found.';
