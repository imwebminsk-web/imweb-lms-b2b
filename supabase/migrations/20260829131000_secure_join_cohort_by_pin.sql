-- Block PIN enrollment for archived cohorts and archived parent courses.
...
COMMENT ON FUNCTION public.join_cohort_by_pin(p_pin text) IS
  'Запись ученика в группу по PIN. Только role=student. requires_approval → pending_approval. suspended блокирует вход. Архивная группа или курс → not_found. Неопубликованный курс → not_found.';
